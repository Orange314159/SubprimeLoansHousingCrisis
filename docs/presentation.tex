...
\logo{\begin{tikzpicture}
        \hspace{-0.78cm}
        \raisebox{-0.73cm}{\includegraphics[width=0.094\textwidth]{logo.jpeg}}
\end{tikzpicture}}
...
\centering
    \includegraphics[height=\textheight]{CDO_-_FCIC_and_IMF_Diagram.png}
\end{frame}
...
\begin{columns}
    ...
    \includegraphics[width=0.5\textwidth, height=\textheight]{960px-Lehman_Brothers_Times_Square_by_David_Shankbone.jpg}
\end{columns}
