...
\logo{\begin{tikzpicture}
        \hspace{-0.78cm}
        \raisebox{-0.73cm}{\includegraphics[width=0.12\textwidth]{logo.jpeg}}
\end{tikzpicture}}
...
\begin{itemize}
    \item We generally consider people with a FICO score of less than 670 to be subprime.  
...
\begin{block}{Sources}
    \begin{itemize}
        ...
        \item HMDA --- The Home Mortgage Disclosure Act passed allows anyone to download a list of every housing loan taken out evey year, including information such as loan ammount, rate spread, hoepa status, etc.
    \end{itemize}
...
\begin{block}{Implications}
    Structural housing supply distortions from the early 2000s subprime expansion continue to shape tract-level housing dynamics today.
\end{block}
